...
<!-- START CONTENT -->
        <section id="content">
		  ...
		  <form class="col s12" method="post" action="<?php echo base_url(); ?>index.php/poll_quiz/savingdata/">
                      <h4 class="header2">Poll Questions</h4>
                      <div class="row">
					   ...
					   $i=0;
						...
						// echo "<pre>".print_r($row,1)."</pre>";
						 ...
						 ?>
						  ...
						  <span class="rating">
						   <input id="rating5" type="radio" name="quiz_value[<?php echo $row->question_id; ?>]" value="5">
							  <label for="rating5">	<?php echo $row->leavel1 ?></label>
							   </br>
							    <input id="rating4" type="radio" name="quiz_value[<?php echo $row->question_id; ?>]" value="4">
							  ...
							  <label for="rating3"><?php echo $row->leavel3 ?></label>
							   ...
							   <input id="rating2" type="radio" name="quiz_value[<?php echo $row->question_id; ?>]" value="2">
							  <label for="rating2"><?php echo $row->leavel4 ?></label>
							  </br>
							  <input id="rating1" type="radio" name="quiz_value[<?php echo $row->question_id; ?>]" value="1" checked>
           ...
           ?>  <h3 class="header2"> Today's Poll Questions completed. Have a Great Day. </h3>
                  ...
                  <div class="col s12 m12 l6">
                    ...
                    <ul id="projects-collection" class="collection z-depth-1">
                      ...
                      <li class="collection-item">
                        <div class="row">
                          <div class="col s5">
                           <span class="task-cat cyan">Vestibulum lobortis</span>
                          </div>
                          <div class="col s2">
                            <span class="task-cat cyan">Pending</span>
                          </div>
                          <div class="col s5">
						  <a class="waves-light green btn" href="<?php echo base_url(); ?>index.php/poll_quiz/old_quiz/<?php echo $row->quiz_date; ?>" > <?php echo $row->quiz_date ?></a>

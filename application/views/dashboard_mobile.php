                ...
                <div class="col s12 m12 l6">
                  <ul id="projects-collection" class="collection z-depth-1" style="background: white;">
                    <li class="collection-item avatar">
                      <i class="material-icons cyan circle"></i>
                      <h6 class="collection-header m-0" style="position: absolute;top: 34px;">Category Rating Chart Performance </h6>
                      
                    </li>
					<?php  if($user_type == 1){?>
                    <h6 style="margin-left: 97px;margin-top: 18px;position: absolute;">Organization</h6>
					<h6 style="margin-left: 294px;    margin-bottom: -15px;position: absolute;margin-top: 17px;">Team & Department</h6>
					
					<div class="input-field col s3" style="width: 224px; margin-left: -7px; margin-top: 36px; position: inherit;">
              ...
              <select  id="dep-list" onChange="drawChartdepartment(this.options[this.selectedIndex].value)" class="form-control" data-live-search="true" style="opacity: 1 !important;">
                  ...
                  <ul id="issues-collection" class="collection z-depth-1" style="background: white;">
                    <li class="collection-item avatar">
                      ...
                      <h6 class="collection-header m-0" style="position: absolute;top: 34px;">YES or No Category Performance </h6>
                     
                    </li>
					<?php  if($user_type == 1){?>
						<h6 style="margin-left: 97px;">Organization</h6>
					<h6 style="margin-left: 273px; position: absolute;margin-top: -25px;">Questions</h6>
              ...
              <div class="row">
                <div class="col s12 m12 l6">
                  <ul id="issues-collection" class="collection z-depth-1" style="background: white;">
                    <li class="collection-item avatar">
                      <i class="material-icons red accent-2 circle">bug_report</i>
                      <h6 class="collection-header m-0" style="position: absolute;top: 34px;">Poll Performance </h6>
                     
                    </li>
                    	<div class="input-field col s8">
                          <?php  if($user_type == 1){?>
                       <h6 style="margin-left: 97px;">Organization</h6>
					<h6 style="margin-left: 305px;margin-bottom: -73px;position: absolute;margin-top: -23px;">Questions</h6>
			...
			<!--work collections start-->
                ...
                <div class="col s12 m12 l6">
                  <ul id="issues-collection" class="collection z-depth-1" style="background: white;">
                    <li class="collection-item avatar">
                      <i class="material-icons red accent-2 circle">bug_report</i>
                      <h6 class="collection-header m-0" style="position: absolute;top: 34px;">compare bar charts Performance </h6>
                     
                    </li>
                    	<div class="input-field col s8">
                          <?php  if($user_type == 1){?>
                     <h6 style="margin-left: 39px;margin-top: -4px;position: absolute;">Organization</h6>
					<h6 style="margin-left: 212px;margin-top: -5px;">Bar 1</h6>
					<h6 style="margin-left: 381px;margin-bottom: -73px;position: absolute;margin-top: -24px; width: 48px;">Bar 2</h6>
					<button class="btn cyan waves-light" onclick="drawChartgroup2()" style="margin-left: 29px;margin-bottom: -73px;position: absolute;margin-top: 82px;background: green;color: white;">Search</button>
					<div class="input-field col s3" style="width: 173px; margin-left: -10px; margin-top: 36px; position: inherit;">
					...
					<div class="input-field col s3" style="width: 173px; margin-left: 139px; margin-top: -34px; position: inherit;">
						...
						<div class="input-field col s3" style="width: 173px; position: absolute; margin-top: 36px;     margin-left: 330px;">

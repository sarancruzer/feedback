        ...
        <section id="content">
          ...
          <div class="container">
           ...
           {  
                ...
                {  
           ?>  <form class="col s12" method="post" action="<?php echo base_url(); ?>index.php/hr_profile/savingdata/<?php echo $row->id; ?>">
                      <h4 class="header2">HR</h4>
                      <div class="row">
           ...
           {  
           ?>  <form class="col s12" method="post" action="<?php echo base_url(); ?>index.php/hr_profile/savingdata/">
                      <h4 class="header2">HR</h4>
                      <div class="row">
                     ...
                     <input  name="org_id" type="hidden" value="<?php echo $this->session->userdata('org_id'); ?>" >
					  ...
					  <?php } ?>
						...
						<div class="input-field col s4">
                          <i class="material-icons prefix">email</i>
                          <input autocomplete="off" placeholder="department" id="department" name="department" type="text" class="typeahead validate" required>
                          <label for="icon_email">Department</label>
                        </div>
		   ...
		   <?php } ?> </div>
			...
			<a class="dropdown-button btn-floating btn-large waves-light" href="http://thoughtbuzz.in/Feedback_system/sample.csv" data-activates="dropdown2">
				  ...
				  <br>
					<form action="<?php echo site_url("hr_profile/upload_file");?>" method="post" enctype="multipart/form-data" id="importFrm" style="display:none">
					<div class="row">
					<?php $user_type = $this->session->userdata('user_type');
                      ...
                      <tbody>
					   ...
					   <?php  
						...
						<td><?php 
                          ...
                          <td><a class="waves-light green btn" href="<?php echo base_url(); ?>index.php/hr_profile/update_data/<?php echo $row->id; ?>" > Edit</a></td>
                          <td><a class="waves-light red btn" href="<?php echo base_url(); ?>index.php/hr_profile/delete_data/<?php echo $row->id; ?>"> Delete</a></td>
                        </tr>
                         <?php       
                }  
           }  
...
<script>  
      $(document).ready(function(){  
      	 ...
      	 <script>  
      $(function() {
  $('#HR_Profile1').addClass('active');
});
      </script> 
	  <script type="text/javascript">
    $('input.typeahead').typeahead({
        source:  function (query, process) {
        return $.get('<?php echo base_url(); ?>index.php/hr_profile/getDepartmentname/', { query: query }, function (data) {
                console.log(data);
                data = $.parseJSON(data);
                return process(data);
            });
